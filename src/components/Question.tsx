...
const Question = ({
  ...
  return (
    <div className="relative w-full max-w-xl bg-gray-300 rounded-xl p-6 sm:p-8 shadow-lg min-h-[600px] flex flex-col justify-between">
    {/* Pop-up Notification (Appears from the Right) */}
    {popupMessage && (
      <div
        className={`fixed top-20 right-5 p-3 text-black font-semibold rounded-md shadow-lg ${popupColor} transition-transform transform animate-slide-in-right`}
      >
        {popupMessage}
      </div>
    )}
    ...
    <h2 className="text-lg sm:text-xl font-bold text-center text-gray-600 bg-white p-5 rounded-md min-h-28 flex items-center">
